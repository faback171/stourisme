			...
			<div class="flexslider">
				<ul class="slides">
					<?php
							...
							$reponse = ("SELECT * FROM Region where idRegion=$idRegion");
							foreach($bd->query($reponse) as $row){?>
			   	<li style="background-image: url(<?php echo $row['photoRegion'];?>);">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="wrap-division">
									<?php
										$idRegion1 = $_GET['idRegion'];
										$rep = ("SELECT * FROM Region where idRegion=$idRegion1");
										foreach($bd->query($rep) as $row){?>
									<div class="row">
										<div class="col-md-12 animate-box">
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="room-img" style="background-image: url(<?php echo $row['photoRegion'];?>);"></div>
													</div>
													<div class="col-md-6 col-sm-6">
														<div class="desc">
															<h2><?php echo $row['nomRegion'];?></h2>
															<p><?php echo $row['descriptionRegion'];?></p>
															<button type="button" class="btn btn-primary btn-block">
				   											<a href="site.php?idRegion=<?php echo($row['idRegion']);?>" class="btn btn-primary btn-block">Sites touristiques</a>
				   											</button>
				   											<button type="button" class="btn btn-primary btn-block">
				   											<a href="guide.php" class="btn btn-primary btn-block">Guides touristiques</a>
				   											</button>
														</div>
													</div>
												</div>
