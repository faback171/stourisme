	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/decouverte.jpg);">
						...
						<div class="row">
							<div class="wrap-division">
								<?php
									...
									$rep = ("SELECT * FROM Site where idRegion=$idRegion");
									foreach($bd->query($rep) as $row){ ?>
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="hotel-room.html" class="hotel-img" style="background-image: url(<?php echo $row['photoSite'];?>">
										</a>
										<div class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
											<h3><a href="hotel-room.html"><?php echo $row['nomSite'];?></a></h3>
											<p><?php echo $row['descriptionSite'];?></p>
											<button type="button" class="btn btn-primary btn-block">
				   							<a href="hotel.php?idSite=<?php echo($row['idSite']);?>" class="btn btn-primary btn-block">Hotels à proximités</a>
				   							</button>
										</div>
									</div>
								</div>
