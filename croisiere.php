	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/croisiere.jpg);">
					...
					<div class="col-md-12">
						<div class="row">
							<div class="wrap-division">
								<?php
									$rep = ("SELECT * FROM croisiere");
									foreach($bd->query($rep) as $row){ ?>
								<div class="col-md-4 col-sm-6 animate-box" style="border-bottom: 1px solid gray;border-style: groove;">
									<div class="hotel-entry">
										<div class="desc">
											<h3><?php echo $row['nom'];?></h3>
											<h4>Adresse : <?php echo $row['adresse'];?></h4>
											<h5>Tel : <?php echo $row['numero'];?></h5>
											<p>E-mail : <a href="mailto:<?php echo $row['email'];?>"><?php echo $row['email'];?></a></p>
										<h4><a href="<?php echo $row['siteweb'];?>"><?php echo $row['siteweb'];?></a></h4>
										</div>
									</div>
								</div>
								<?php } ?>
