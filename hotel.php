					...
					<div class="col-md-12">
						<div class="row">
							<div class="wrap-division">
								<?php
									$idSite = $_GET['idSite'];
									$rep = ("SELECT * FROM Hotel where idSite=$idSite");
									foreach($bd->query($rep) as $row){ ?>
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="hotel-entry">
										<a href="hotel-room.html" class="hotel-img" style="background-image: url(<?php echo $row['photoHotel'];?>">
										</a>
										<div class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
											<h3><a href="hotel-room.html"><?php echo $row['nomHotel'];?></a></h3>
											<p><?php echo $row['descriptionHotel'];?></p>
											<h4><?php echo $row['numeroHotel'];?></h4>
											<button type="button" class="btn btn-primary btn-block">
				   							<a href="<?php echo $row['sitewebHotel'];?>" class="btn btn-primary btn-block">Réserver</a>
				   							</button>
										</div>
									</div>
								</div>
