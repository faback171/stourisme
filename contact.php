	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/contact.png);">
				...
				<div class="row">
						...
						<form action="envoi.php" method="post">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" id="email" name="email" class="form-control" placeholder="Votre addresse email">
								</div>
							</div>
					...
					<div class="col-md-10 col-md-offset-1 animate-box">
						...
						<div class="row contact-info-wrap">
							<div class="col-md-3">
								<p><span><i class="icon-location"></i></span> Parcelles assainies unité 25, <br> Dakar,Sénégal</p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-phone3"></i></span> <a href="tel://+221783031652">+221783031652</a></p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-paperplane"></i></span> <a href="mailto:lifeiscode2020@gmail.com">lifeiscode2020@gmail.com</a></p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-globe"></i></span> <a href="https://empreintedusenegal.com/">empreintedusenegal.com</a></p>
							</div>
						</div>
					</div>
				</div>
